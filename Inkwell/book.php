...
?>
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="books.php" class="text-decoration-none text-muted fw-light">Genres</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          <div class="card rounded-0 shadow">
            <div class="card-body" style="background: url('./bootstrap/img/clouds.jpg') no-repeat center center; background-size: cover;">
