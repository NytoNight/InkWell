<?php
	...
	if(isset($_POST['add'])){
		...
		$query = "INSERT INTO books (`book_isbn`, `book_title`, `book_author`, `book_image`, `book_descr`, `book_price`, `publisherid`, `Release Date`) VALUES ('" . $isbn . "', '" . $title . "', '" . $author . "', '" . $image . "', '" . $descr . "', '" . $price . "', '" . $publisherid . "', '" . $release_date . "')";
					...
					<div class="container-fluid">
						...
						<form method="post" action="admin_add.php" enctype="multipart/form-data">
								...
								<div class="mb-3">
									...
									<input class="form-control rounded-0" type="date" name="release_date" required>
								</div>
