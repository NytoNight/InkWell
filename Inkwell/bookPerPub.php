...
<style>
	...
	#pubBooks {
		background-image: url('./bootstrap/img/footer-img-4.png');
		background-size: cover;
		background-repeat: no-repeat;
		background-position: center;
	}
	.card.rounded-0.shadow {
		background-image: url('./bootstrap/img/clouds.jpg');
		background-size: cover;
		background-repeat: no-repeat;
		background-position: center;
	}
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="genre_list.php" class="text-decoration-none text-muted fw-light">Genres</a></li>
	...
	<div class="row book-item mb-2">
		<div class="col-md-3">
			<div class="img-holder overflow-hidden">
				<img class="img-top" src="./bootstrap/img/<?php echo $row['book_image'] ?: 'default-book.png'; ?>">
			</div>
		</div>
		<div class="col-md-9">
